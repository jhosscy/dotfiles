...
import { collectHiddenExtensionStatusKeys, getNotificationExtensionStatuses, parsePowerlineConfig } from "./powerline-config.js";
...
export default function powerlineFooter(pi: ExtensionAPI) {
  ...
  function buildSegmentContext(ctx: any, theme: Theme): SegmentContext {
    ...
    const gitStatus = getGitStatus(gitBranch, ctx.cwd);
